...
public class PauseOverlayFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Bloquear el botón físico de atrás
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        tv.setBackgroundColor(Color.argb(230, 10, 14, 26)); // hud_bg semitransparente
        tv.setLayoutParams(new ViewGroup.LayoutParams(
                ViewGroup.LayoutParams.MATCH_PARENT,
                ViewGroup.LayoutParams.MATCH_PARENT));
        tv.setClickable(true); // absorbe toques para que no pasen al grid
